...
/*   Updated: 2021/05/12 21:34:29 by jean-phil        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_joinTest()
{
char *chat = "helpttttttttttttttttttttttttttt";
char *dog = "nssssssssssssssssssssssssssssssssssssssssssss o";

printf("%s",ft_strjoin(dog ,chat));
